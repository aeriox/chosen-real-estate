    ...
    <>
      ...
      >
        ...
        <nav className={cn(
          ...
          {/* Logo */}
          <Link to="/" className="relative flex items-center h-full lg:ml-[-8.8125rem] max-lg:absolute max-lg:left-1/2 max-lg:-translate-x-1/2">
            ...
            <img
              ...
              className={cn(
                "w-auto max-w-none shrink-0 transition-all duration-500 absolute",
            ...
            <img
              ...
              alt="Chosen Real Estate Advisors"
              className={cn(
                "w-auto max-w-none shrink-0 transition-all duration-500",
