  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1582407947092-78cafee3c5d3?q=80&w=2670&auto=format&fit=crop"
      ...
      <div className="relative z-10 container px-4 text-center">
        ...
        >
          ...
          <a
            href="#"
            className="inline-block bg-gold text-accent-foreground px-10 py-4 text-xs tracking-[0.2em] hover:bg-gold-dark transition-colors"
          >
